    ...
    return ThemeData(
      ...
      textButtonTheme: TextButtonThemeData(
        style: TextButton.styleFrom(
            textStyle: textTheme.labelLarge,
            padding: const EdgeInsetsDimens.vertical(AppDimens.paddingNormal)
                .add(EdgeInsetsDimens.screenHorizontal()),
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(AppDimens.borderRadius),
            )),
      ),
      ...
      appBarTheme: AppBarTheme(
        ...
        titleTextStyle: textTheme.titleLarge
            ?.apply(color: AppColorsThem.primaryTextColor(themval)),
        elevation: 0,
      ),
      cardTheme: CardThemeData(
          shape: RoundedRectangleBorder(
            borderRadius:
                const BorderRadius.all(Radius.circular(AppDimens.cellRadius)),
          ),
      ...
      searchBarTheme: SearchBarThemeData(
        ...
        backgroundColor:
            WidgetStateProperty.all(AppColorsThem.surfaceColor(themval)),
        hintStyle: WidgetStateProperty.all(textTheme.bodyLarge
            ?.copyWith(color: AppColorsThem.secondaryTextColor(themval))),
        ...
        padding: const WidgetStatePropertyAll<EdgeInsets>(EdgeInsets.symmetric(
            horizontal: AppDimens.paddingNormal, vertical: 0)),
      ),
      inputDecorationTheme: InputDecorationTheme(
        ...
        disabledBorder: OutlineInputBorder(
            borderSide: BorderSide(
                color: AppColorsThem.disabledButtonColor(themval), width: 1)),
      ),
    );
  }
